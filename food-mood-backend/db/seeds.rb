...
favs = List.create!(name: "All time favorites", description: "A list of my favorite restaurants and recipes.", user: trejon)
must_try = List.create!(name: 'Must try meals', description: "A list of restaurants and recipes I really want to try.", user: trejon)
